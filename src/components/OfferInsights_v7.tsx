...
const beforePalette = {
  card: 'bg-gradient-to-br from-fuchsia-500 to-rose-500',
  text: 'text-fuchsia-200',
  track: 'bg-fuchsia-100 dark:bg-slate-800',
  fill: 'bg-gradient-to-r from-fuchsia-500 to-rose-500',
  shadow: 'shadow-[0_0_30px_rgba(236,72,153,0.22)]',
  ringA: '#d946ef',
  ringB: '#fb7185',
};

const afterPalette = {
  card: 'bg-gradient-to-br from-cyan-500 to-blue-500',
  text: 'text-cyan-200',
  track: 'bg-cyan-100 dark:bg-slate-800',
  fill: 'bg-gradient-to-r from-cyan-500 to-blue-500',
  shadow: 'shadow-[0_0_30px_rgba(6,182,212,0.24)]',
  ringA: '#06b6d4',
  ringB: '#3b82f6',
};
    ...
    <div className="rounded-2xl bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 border border-slate-800 p-4 text-white">
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div className="flex flex-col items-center">
          <div
            className={`relative h-24 w-24 rounded-full flex items-center justify-center ${beforePalette.shadow}`}
            style={buildRingStyle(beforePercent, beforePalette.ringA, beforePalette.ringB)}
          >
        ...
        <div className="flex flex-col items-center">
          <div
            className={`relative h-24 w-24 rounded-full flex items-center justify-center ${afterPalette.shadow}`}
            style={buildRingStyle(afterPercent, afterPalette.ringA, afterPalette.ringB)}
          >
            <div className="h-16 w-16 rounded-full bg-slate-950 flex flex-col items-center justify-center text-center">
  ...
  return (
    <section className="rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 p-4 md:p-6 space-y-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-3">
        <div className="rounded-xl border border-fuchsia-200 dark:border-fuchsia-900/50 bg-gradient-to-br from-fuchsia-500 to-rose-500 p-4 text-white">
        ...
        <div className="rounded-xl border border-cyan-200 dark:border-cyan-900/50 bg-gradient-to-br from-cyan-500 to-blue-500 p-4 text-white">
                ...
                <div key={item.label}>
                  ...
                  <div className="mt-2 space-y-2">
                    <div>
                      ...
                      <div className={`h-3 rounded-full overflow-hidden ${beforePalette.track}`}>
                        <div className={`h-full rounded-full ${beforePalette.fill}`} style={{ width: `${beforeWidth}%` }} />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className={`h-3 rounded-full overflow-hidden ${afterPalette.track}`}>
                        <div className={`h-full rounded-full ${afterPalette.fill}`} style={{ width: `${afterWidth}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
