              ...
              return (
                <div key={item.label} className="rounded-xl bg-slate-50 dark:bg-slate-900 p-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`font-medium ${isEqual ? 'text-amber-600 dark:text-amber-400' : 'text-gray-500 dark:text-gray-400'}`}>
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div>
                      ...
                      <div className={`h-3 rounded-full overflow-hidden ${isEqual ? 'bg-amber-100 dark:bg-amber-950/30' : 'bg-cyan-100 dark:bg-cyan-950/30'}`}>
                        <div
                          className={`h-full rounded-full ${isEqual ? 'bg-gradient-to-r from-amber-400 to-orange-500' : `bg-gradient-to-r ${afterBarClass}`}`}
