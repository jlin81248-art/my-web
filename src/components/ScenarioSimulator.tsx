      ...
      <div className="mt-5 grid grid-cols-1 gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="rounded-[24px] border border-black/5 bg-[#FCFBF8] p-4">
            <div className="text-sm font-medium text-slate-700">娱乐水平</div>
            <select
        ...
        <div className="rounded-[24px] border border-black/5 bg-[#FAF8F4] p-5">
          <div className="text-sm uppercase tracking-[0.18em] text-slate-400">Live result</div>
          <div className="mt-3 text-2xl font-semibold text-slate-950">当前模拟结果</div>

          <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3 xl:grid-cols-1">
            <Metric label="匹配分" value={scoreText} />
