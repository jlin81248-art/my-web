              ...
              <div className="mt-4 space-y-3">
                <div>
                  <div className="mb-1 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span>{beforeValueLabel(item.beforeValue, item.suffix)}</span>
                  </div>
                ...
                <div>
                  <div className="mb-1 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span>{beforeValueLabel(item.afterValue, item.suffix)}</span>
                  </div>
...
function beforeValueLabel(value: number, suffix: string): string {
